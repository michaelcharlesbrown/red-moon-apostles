...
export default function TimelineSequencesPage() {
  return (
    <main className="flex min-h-screen flex-col bg-[#101113] px-6 py-16 text-[#e5e5e5]">
      ...
      <p className="mt-2 text-[#888]">
        Complex multi-step GSAP timelines — orchestrated entrances, chained
        transitions, and interactive playback control.
      </p>
