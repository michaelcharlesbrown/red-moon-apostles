...
export default function LayoutAnimationsPage() {
  return (
    <main className="flex min-h-screen flex-col bg-[#101113] px-6 py-16 text-[#e5e5e5]">
      ...
      <p className="mt-2 text-[#888]">
        Automatic layout transitions — list reordering, shared element
        morphing, expandable cards, and fluid grid rearrangements.
      </p>
